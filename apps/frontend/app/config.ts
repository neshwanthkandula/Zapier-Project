...
export const BACKEND_URL = `http://${VM_IP}:${BACKEND_PORT}/api/v1` || "http://localhost:3004/api/v1";
export const HOOK_URL = `http://${VM_IP}:${HOOK_PORT}/hooks/catch/` || "http://localhost:3003/hooks/catch/";
